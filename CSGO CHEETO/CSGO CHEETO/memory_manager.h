...
const int HEAD_BONE_ID = 10;

const int ENTITY_LIST_OFFSET = 0x04A22534;
...
const int HEAD_POSITION_X_OFFSET = 0x0C;
const int HEAD_POSITION_Y_OFFSET = 0x1C;
const int HEAD_POSITION_Z_OFFSET = 0x2C;
